...
class PostModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        qc1 = Comment.objects.create(
            user=u2,
            content="질문1 코멘트 내용",
            post_type=PostType.objects.get(question=q1),
        )
        ...
        ac1 = Comment.objects.create(
            ...
            post_type=PostType.objects.get(answer=a1),
        )

    def test_nested_comment_content(self):
        qc1 = Comment.objects.get(content="질문1 코멘트 내용")
        qc1_nested_1 = Comment.objects.get(content="질문1 코멘트 nested 코멘트")
