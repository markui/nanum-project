...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='users_with_expertise', to='topics.Topic'),
        ),
        migrations.AddField(
            model_name='user',
            name='topic_interests',
            field=models.ManyToManyField(related_name='users_with_interest', to='topics.Topic'),
        ),
        migrations.AddField(
            model_name='user',
